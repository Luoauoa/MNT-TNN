...
EN_NTTNN      = 1;
EN_TBTTNN     = 1;
method_name   = {'Observed','TNN','UTNN','NTTNN', 'TBTTNN'};
...
subplot(6,1,2);plot(squeeze(Re_tensor{5}(6,6,1:300)), 'linewidth', 1.5, 'DisplayName','Imputed Value');title('ATTNNs'); hold on
